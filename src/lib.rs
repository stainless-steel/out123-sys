...
extern {
    ...
    pub fn out123_param(ao: *mut out123_handle, code: out123_parms, value: c_long, fvalue: c_double, svalue: *const c_char) -> c_int;
    pub fn out123_getparam(ao: *mut out123_handle, code: out123_parms, ret_value: *mut c_long, ret_fvalue: *mut c_double, ret_svalue: *mut *mut c_char) -> c_int;
    pub fn out123_param_from(ao: *mut out123_handle, from_ao: *mut out123_handle) -> c_int;
    pub fn out123_drivers(ao: *mut out123_handle, names: *mut *mut *mut c_char, descr: *mut *mut *mut c_char) -> c_int;
    pub fn out123_open(ao: *mut out123_handle, driver: *const c_char, device: *const c_char) -> c_int;
    pub fn out123_driver_info(ao: *mut out123_handle, driver: *mut *mut c_char, device: *mut *mut c_char) -> c_int;
    ...
    pub fn out123_formats(ao: *mut out123_handle, rates: *const c_long, ratecount: c_int, minchannels: c_int, maxchannels: c_int, fmtlist: *mut *mut mpg123_fmt) -> c_int;
    ...
    pub fn out123_start(ao: *mut out123_handle, rate: c_long, channels: c_int, encoding: c_int) -> c_int;
    ...
    pub fn out123_getformat(ao: *mut out123_handle, rate: *mut c_long, channels: *mut c_int, encoding: *mut c_int, framesize: *mut c_int) -> c_int;
}
